...
description: >
  Dry-run the full fw setup onboarding wizard on a fictional test project (/opt/test-project). Walk through every step, verify produced artifacts (CLAUDE.md, hooks, .tasks/, .context/), test the workflow (task create, commit, audit), fix any issues found in the framework, then clean up.
...
last_update: 2026-02-17T11:22:57Z
