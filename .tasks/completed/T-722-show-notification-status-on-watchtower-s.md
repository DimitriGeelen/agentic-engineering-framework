---
id: T-722
name: "Show notification status on Watchtower settings page"
description: >
...
### Agent
- [x] Settings page shows notification enabled/disabled state
- [x] Settings page shows dispatcher availability
- [x] Page loads without error at /settings/
...
### 2026-03-29T18:31:40Z — task-created [task-create-agent]
