---
id: T-672
name: "Add priority sorting to approvals page — urgent/stale items first, rubber-stamps
  last"
description: >
  Add priority sorting to approvals page — urgent/stale items first, rubber-stamps
  last
