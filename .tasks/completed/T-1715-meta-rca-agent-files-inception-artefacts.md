---
id: T-1715
name: "Meta-RCA: agent files inception artefacts without ## Recommendation block,
  forcing human to decide on incomplete advisory (T-679 rule recurring violation)"
description: >
  Inception: Meta-RCA: agent files inception artefacts without ## Recommendation block,
  forcing human to decide on incomplete advisory (T-679 rule recurring violation)
