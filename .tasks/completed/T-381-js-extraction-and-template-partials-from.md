...
description: >
  Extract 416 lines of inline JS from search.html into web/static/js/{utils.js, markdown-render.js,
  search-qa.js}. Create Jinja2 partials in web/templates/_partials/. Reduce search.html
  from 567 to ~15 lines. Depends on T-380 (UX redesign). Parent: T-375.
