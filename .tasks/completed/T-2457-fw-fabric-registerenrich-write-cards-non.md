---
id: T-2457
name: "fw fabric register/enrich write cards non-atomically — spurious unregistered
  drift FP (OBS-080)"
description: >
  fw fabric register/enrich write cards non-atomically — spurious unregistered drift
  FP (OBS-080)
...
components: [agents/fabric/lib/register.sh, 
      tests/unit/t2457_fabric_atomic_card_write.bats]
related_tasks: []
