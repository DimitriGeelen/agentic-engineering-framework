---
id: T-1485
name: "Reviewer v1.5c — fw reviewer audit --pass-a corpus drift mode (baseline init
  + drift scan)"
description: >
  Reviewer v1.5c — fw reviewer audit --pass-a corpus drift mode (baseline init + drift
  scan)
