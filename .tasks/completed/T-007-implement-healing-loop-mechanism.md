...
description: >
  Per 010-TaskSystem.md: when task status changes to issues, healing loop should activate
  - classify failure, suggest recovery, log pattern. Currently specified but not implemented.
