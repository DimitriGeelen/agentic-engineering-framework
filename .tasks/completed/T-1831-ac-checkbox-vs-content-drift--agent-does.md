...
- [x] [REVIEW] Decide on prevention pattern (Layer 1) AND triage Layer 2 (file follow-up bug task if error #4 is a regression vs known behaviour)
  **Steps:**
  ...
  3. Decide which Layer 1 candidate (C-1 / C-2 / C-3 / C-4 / multiple)
  4. Run: `cd /opt/999-Agentic-Engineering-Framework && bin/fw inception decide T-1831 <decision> --rationale "..."`
  **Expected:** Layer 1 decision recorded; Layer 2 either resolved (known) or new task filed (regression).
