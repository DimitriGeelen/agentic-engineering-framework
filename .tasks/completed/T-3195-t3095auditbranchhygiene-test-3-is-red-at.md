---
id: T-3195
name: "t3095_audit_branch_hygiene test 3 is red at HEAD and nothing surfaces it"
description: >
  tests/unit/t3095_audit_branch_hygiene.bats test 3 ('linked worktree: INFO skip,
  never WARN') fails at HEAD: the assertion grep -q '^INFO|Branch hygiene skipped
  - linked worktree' finds no such line. Confirmed pre-existing by checking out HEAD's
  lib/branch-hygiene.sh and re-running - not caused by T-3188. A red unit test sitting
...
horizon: null
tags: []
components: [C-004, agents/handover/handover.sh, bin/fw, lib/branch-hygiene.sh, lib/worktree.sh]
related_tasks: []
...
last_update: 2026-08-27T19:46:15Z
date_finished: 2026-08-27T19:46:15Z
...
# T-3195: t3095_audit_branch_hygiene test 3 is red at HEAD and nothing surfaces it
...
### 2026-08-27T08:05:16Z — task-created [task-create-agent]
...
### 2026-08-27T19:46:15Z — status-update [task-update-agent]
