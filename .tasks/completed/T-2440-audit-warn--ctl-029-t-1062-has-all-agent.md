---
id: T-2440
name: "Audit WARN — CTL-029: T-1062 has all Agent ACs ticked but status='started-work' — c..."
description: >
...
Audit run: 2026-07-02T18:36:58Z
Finding: CTL-029: T-1062 has all Agent ACs ticked but status='started-work' — completable, not closed

## Finding

```
CTL-029: T-1062 has all Agent ACs ticked but status='started-work' — completable, not closed
```

Mitigation: Run: bin/fw task update T-1062 --status work-completed
