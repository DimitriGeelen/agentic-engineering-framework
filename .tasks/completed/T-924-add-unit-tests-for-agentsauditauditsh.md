---
id: T-924
name: "Add unit tests for agents/audit/audit.sh"
description: >
...
Audit agent (3274 lines) has no unit tests. Testing help, sections, output format, and exit codes.

## Acceptance Criteria

### Agent
- [x] Test file exists at tests/unit/audit.bats
- [x] Tests cover help, section filtering, output format, exit codes, quiet mode, YAML output
...
### 2026-04-05T16:09:25Z — task-created [task-create-agent]
