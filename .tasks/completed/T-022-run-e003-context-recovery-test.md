...
description: >
  Execute experiment E-003 to validate that handover + resume agent enables recovery
  after context loss. Simulate compaction scenario, use only resume tools to recover,
  measure time to productive and accuracy of recovery.
