---
id: T-656
name: "Update CLAUDE.md cron reference with full command set"
description: >
...
Add full `fw cron` command set (run/pause/resume/list) to CLAUDE.md Quick Reference table and document the cron registry pattern.

## Acceptance Criteria

### Agent
- [x] CLAUDE.md Quick Reference includes all 6 fw cron subcommands
- [x] Brief cron registry documentation added to relevant section
...
### 2026-03-28T15:47:23Z — task-created [task-create-agent]
