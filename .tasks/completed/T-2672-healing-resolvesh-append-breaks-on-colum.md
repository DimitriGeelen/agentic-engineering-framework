---
id: T-2672
name: "healing resolve.sh: append breaks on column-0 YAML + max-id scan misses unindented
  ids (832 field T-295)"
description: >
  healing resolve.sh: append breaks on column-0 YAML + max-id scan misses unindented
  ids (832 field T-295)
