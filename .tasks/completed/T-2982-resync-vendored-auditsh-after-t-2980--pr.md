---
id: T-2982
name: "resync vendored audit.sh after T-2980 — pre-push self-vendor check is blocking"
description: >
  resync vendored audit.sh after T-2980 — pre-push self-vendor check is blocking
...
created: 2026-08-14T08:05:12Z
last_update: '2026-08-16T22:25:25Z'
date_finished: 2026-08-14T08:12:29Z
...
# T-2982: resync vendored audit.sh after T-2980 — pre-push self-vendor check is blocking
...
- [x] The recurrence is recorded rather than absorbed: this is the second time in one
      session (T-2975 was the first) that a source edit stranded the push behind stale
      vendored copies, which is a workflow observation worth having in the register
- [x] The two untracked files `fw vendor self` also copied — `lib/antigravity_bridge.py`
      and `agents/sessions/antigravity/list.sh`, authored ~09:48 today by a parallel
      session — are NOT committed to the vendored tree. They are someone else's in-flight
      source; vendoring them would ship unreviewed working-tree code to every consumer.
      Logged as OBS-245 (urgent) rather than silently worked around
...
### 2026-08-14T08:05:12Z — task-created [task-create-agent]
- **Action:** Created task via task-create agent
- **Output:** /opt/999-Agentic-Engineering-Framework/.tasks/active/T-2982-resync-vendored-auditsh-after-t-2980--pr.md
- **Context:** Initial task creation

## Reviewer Verdict (v1.5)

- **Scan ID:** R-b06a3453
- **Timestamp:** 2026-08-14T08:12:30Z
- **Catalogue:** v1.3-seed
- **Overall:** CONCERN
- **Needs Human:** no
- **Findings:** 2
...
**Verification-level findings:**
  ...
  1. **empty-output-success** (partial, heuristic) @ Verification:line 77
     - evidence: `! git ls-files --error-unmatch .agentic-framework/lib/antigravity_bridge.py 2>/dev/null`
  2. **empty-output-success** (partial, heuristic) @ Verification:line 78
     - evidence: `! git ls-files --error-unmatch .agentic-framework/agents/sessions/antigravity/list.sh 2>/dev/null`

### 2026-08-14T08:12:29Z — status-update [task-update-agent]
