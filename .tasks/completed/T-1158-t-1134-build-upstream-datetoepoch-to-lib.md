---
id: T-1158
name: "T-1134 build: Upstream _date_to_epoch to lib/compat.sh + fix 3 GNU-only date -d sites"
description: >
  T-1134 build: Upstream _date_to_epoch to lib/compat.sh + fix 3 GNU-only date -d sites
...
last_update: 2026-04-12T12:05:43Z
