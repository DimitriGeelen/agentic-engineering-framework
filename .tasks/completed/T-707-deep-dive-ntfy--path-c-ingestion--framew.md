...
description: >
  Path C deep-dive on github.com/binwiederhier/ntfy (push notification service). Two
  deliverables: (1) Ingest codebase, harvest patterns, score against D1-D4. (2) Build
  natural enhancement — wire ntfy into framework notification surface (Tier 0 approvals,
  task completions, audit alerts). Third Path C experiment validating template.
