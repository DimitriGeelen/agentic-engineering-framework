...
description: >
  Repair command for duplicate task IDs. Updates filename + frontmatter + commit references
  atomically. Deferred from T-1279 — the audit check now surfaces dups; manual rename
  is sufficient for rare case, but a command would be safer/faster.
