...
description: >
  web/shared.py::build_ambient currently picks the first active task alphabetically
  as focus_task. Change to read .context/working/focus.yaml::current_task first, falling
  back to existing logic only if null/missing. Sibling to T-1304 inception (pickup
  from termlink T-1127).
