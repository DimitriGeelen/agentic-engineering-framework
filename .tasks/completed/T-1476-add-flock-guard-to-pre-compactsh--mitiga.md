---
id: T-1476
name: "Add flock guard to pre-compact.sh — mitigate dual-handover commits from concurrent
  hook fires (OBS-023)"
description: >
  Add flock guard to pre-compact.sh — mitigate dual-handover commits from concurrent
  hook fires (OBS-023)
