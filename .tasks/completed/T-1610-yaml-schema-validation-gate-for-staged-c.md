---
id: T-1610
name: "YAML schema-validation gate for staged .context/project/*.yaml — prevent silent
  corruption"
description: >
  YAML schema-validation gate for staged .context/project/*.yaml — prevent silent
  corruption
