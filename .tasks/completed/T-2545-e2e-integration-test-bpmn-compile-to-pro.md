---
id: T-2545
name: "E2E integration test: BPMN compile to promote to create against real gate (forward
  bridge)"
description: >
  E2E integration test: BPMN compile to promote to create against real gate (forward
  bridge)
