---
id: T-1263
name: "Fix inception template validation: fail-fast on missing Recommendation/Decision
  sections"
description: >
  Fix inception template validation: fail-fast on missing Recommendation/Decision
  sections
...
bvp_scores_proposed:
  - ts: '2026-06-11T22:23:44Z'
    ...
    rationale: D1=3 (body:test-or-audit-check); D2=4 (body:fw-audit-or-doctor); 
      D3=0 (no-signal); D4=4 (body:cross-machine); F-RECALL=0 (no-signal); 
