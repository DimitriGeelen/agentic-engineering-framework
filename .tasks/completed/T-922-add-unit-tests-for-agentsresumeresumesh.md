---
id: T-922
name: "Add unit tests for agents/resume/resume.sh"
description: >
...
agents/resume/resume.sh is used in every session recovery but has no unit tests.

## Acceptance Criteria

### Agent
- [x] Test file exists at tests/unit/resume.bats
- [x] Tests cover help, routing, quick, status, sync output
...
### 2026-04-05T16:04:51Z — task-created [task-create-agent]
