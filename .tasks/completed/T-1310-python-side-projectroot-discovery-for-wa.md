...
description: >
  Add _discover_project_root() walking up from CWD for .framework.yaml, and _resolve_project_root()
  returning (path, source_label). PROJECT_ROOT = env > discovered > FRAMEWORK_ROOT.
  Log source at import. Sibling to T-1303 inception (pickup from termlink T-1123).
