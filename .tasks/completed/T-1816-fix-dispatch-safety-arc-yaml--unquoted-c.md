---
id: T-1816
name: "fix dispatch-safety arc YAML — unquoted colon in name field breaks Watchtower
  /arcs page"
description: >
  fix dispatch-safety arc YAML — unquoted colon in name field breaks Watchtower /arcs
  page
