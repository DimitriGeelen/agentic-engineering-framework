---
id: T-1675
name: "Project-shape conflation umbrella — framework code assumes consumer shape,
  silently fails in framework repo / fresh-init / vendored states"
description: >
  Project-shape conflation umbrella — framework code assumes consumer shape, silently
  fails in framework repo / fresh-init / vendored states
