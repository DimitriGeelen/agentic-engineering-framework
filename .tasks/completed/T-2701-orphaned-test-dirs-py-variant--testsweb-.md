...
horizon: null
tags: []
components: [bin/fw, tests/lint/no-orphaned-test-dirs.bats]
related_tasks: []
...
last_update: 2026-07-31T11:11:29Z
date_finished: 2026-07-31T11:11:29Z
...
- **Scan ID:** R-aafd5497
- **Timestamp:** 2026-07-31T11:11:45Z
- **Catalogue:** v1.3-seed
- **Overall:** CONCERN
- **Needs Human:** no
- **Findings:** 1
...
**Verification-level findings:**
  ...
  1. **l387-sigpipe-risk** (partial, heuristic) @ Verification:line 34
     - evidence: `python3 -m pytest web/test_app.py tests/web/ --collect-only -q 2>&1 | grep -q "277 tests collected"`

### 2026-07-31T11:11:29Z — status-update [task-update-agent]
