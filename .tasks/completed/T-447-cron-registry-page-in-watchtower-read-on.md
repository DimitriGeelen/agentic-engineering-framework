...
components: [web/blueprints/cron.py, web/blueprints/__init__.py, web/shared.py, 
...
### Human
- [x] [REVIEW] Cron registry page renders correctly — verified via Playwright: 10 jobs, grid layout, schedule/result/source columns and is useful
  **Steps:**
