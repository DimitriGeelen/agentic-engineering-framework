---
id: T-2932
name: "fw note count reports urgent from a whole-file grep — dismissed observations
  still counted"
description: >
  fw note count reports urgent from a whole-file grep — dismissed observations still
  counted
