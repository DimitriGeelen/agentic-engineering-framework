---
id: T-100137
name: "emit-tasks bats test 3 races live .tasks/active — assert on dry-run output
  not dir counts (OBS-080)"
description: >
...
# T-100137: test_audit_emit_tasks.bats test 3 (dry-run creates no files) counts the LIVE .tasks/active directory before/after running a real audit — inherently racy against concurrent task creation (cron --emit-tasks, BVP estimator, parallel sessions, the operator). Observed live 2026-07-04: concurrent T-100136 creation during suite run flipped the count and failed the test. Candidate fix: sandbox TASKS_DIR for the test, or assert on the audit's own [CREATED] output instead of directory counts. (T-100135)
...
### 2026-07-04T09:51:58Z — task-created [task-create-agent]
- **Action:** Created task via task-create agent
- **Output:** /opt/999-Agentic-Engineering-Framework/.tasks/active/T-100137-testauditemittasksbats-test-3-dry-run-cr.md
