---
id: T-2476
name: "investigate PyYAML timestamp round-trip corruption class — register concern,
  fix if systemic"
description: >
  investigate PyYAML timestamp round-trip corruption class — register concern, fix
  if systemic
