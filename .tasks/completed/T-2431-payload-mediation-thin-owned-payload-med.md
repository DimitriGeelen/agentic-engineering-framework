...
description: >
  Build the governance mediator: parse streaming tool_use blocks, evaluate policy,
  allow/deny/rewrite/route, compose streaming-coherent denial (unknown #2). Model-agnostic
  at the protocol. Gated on T-2428 GO + spike T-2429.
