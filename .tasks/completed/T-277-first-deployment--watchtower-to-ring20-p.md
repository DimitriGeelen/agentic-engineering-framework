...
description: >
  Execute first production deployment of Watchtower. Use fw deploy scaffold, validate
  with /deploy-check, push to registry, deploy via Swarm, verify health through Traefik
  FQDN. Document deployment runbook. Depends on T-274 (scaffold) and T-275 (quality
  gate). See docs/reports/T-272-deploy-watchtower-ring20.md.
