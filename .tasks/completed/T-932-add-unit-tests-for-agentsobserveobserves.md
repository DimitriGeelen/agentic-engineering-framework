---
id: T-932
name: "Add unit tests for agents/observe/observe.sh"
description: >
...
Observe agent (fw note) is the last agent without tests. Testing help, note capture, list, count.

## Acceptance Criteria

### Agent
- [x] Test file exists at tests/unit/observe.bats
- [x] Tests cover help, capture, list, count, tags, empty input
...
### 2026-04-05T16:29:09Z — task-created [task-create-agent]
