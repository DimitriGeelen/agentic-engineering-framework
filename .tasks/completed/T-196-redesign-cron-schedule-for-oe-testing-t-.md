...
description: >
  Replace/augment /etc/cron.d/agentic-audit with 4-tier OE schedule: 30min (oe-fast),
  hourly (oe-hourly), daily (oe-daily), weekly (oe-weekly). Preserve existing structural
  audit sections. Reference: docs/reports/T-194-control-register.md Phase 3 Proposed
  Cron Redesign.
