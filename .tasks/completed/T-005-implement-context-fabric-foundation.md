...
description: >
  Create .context/ directory and implement the three memory types (Working, Project,
  Episodic) specified in 010-TaskSystem.md. This is foundational - many other features
  depend on it.
