---
id: T-1625
name: "Pickup: Six framework-level bugs surfaced as long-watching concerns in 003-NTB-ATC-Plugin.
  Project is decide-deferring all six locally and forwarding upstream so framework-agent
  can prioritize fixes. (from 003-NTB-ATC-Plugin)"
description: >
  Auto-created from pickup envelope. Source: 003-NTB-ATC-Plugin, task T-271. Type:
  bug-report.
