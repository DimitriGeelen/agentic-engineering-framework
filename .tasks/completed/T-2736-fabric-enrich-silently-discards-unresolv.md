---
id: T-2736
name: "Fabric enrich discards unresolvable and ignorable edges through one silent
  branch"
description: >
  Fabric enrich silently discards unresolvable edges, so its own mitigation cannot
  move the metric
...
horizon:
tags: []
components: [tests/unit/test_enrich_unresolved_targets.py]
related_tasks: []
...
date_finished: 2026-08-02T13:06:20Z
...
- **Scan ID:** R-b7b6c7cc
- **Timestamp:** 2026-08-02T13:06:29Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-08-02T13:06:20Z — status-update [task-update-agent]
