---
id: T-714
name: "Add fw notify to help text"
description: >
...
### Agent
- [x] `fw help` output includes `notify` command
- [x] `fw notify` help text is consistent with other commands
...
### 2026-03-29T14:14:14Z — task-created [task-create-agent]
