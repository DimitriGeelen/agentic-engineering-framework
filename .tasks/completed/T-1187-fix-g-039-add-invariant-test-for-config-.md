---
id: T-1187
name: "Fix G-039: add invariant test for config registry parity across lib/config.sh, web/blueprints/config.py, CLAUDE.md"
description: >
  Fix G-039: add invariant test for config registry parity across lib/config.sh, web/blueprints/config.py, CLAUDE.md
...
last_update: 2026-04-12T21:27:48Z
