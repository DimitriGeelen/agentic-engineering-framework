...
description: >
  Forensic investigation revealed T-108 was closed prematurely: 6 commits over 173min
  after work-completed status, stale episodic, orphaned decisions. Document findings
  as learning+pattern+decision, write research doc, create mitigation tasks (acceptance
  criteria gate, closed task commit warning).
