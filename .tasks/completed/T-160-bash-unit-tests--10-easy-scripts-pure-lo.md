...
description: >
  Write bats unit tests for the 10 EASY-rated scripts: context.sh, log.sh, healing.sh,
  focus.sh, common.sh, bus-handler.sh, status.sh (git), suggest.sh, pre-compact.sh,
  diagnose.sh. Target: 569 lines covered, 100% of pure logic. Ref: T-158, /tmp/T-158-bash-audit.md
