...
description: >
  From T-179 GO. Register a SessionStart hook with matcher 'resume' that injects handover
  context when claude -c restarts the session. Extends the existing post-compact-resume.sh
  or creates a parallel hook.
