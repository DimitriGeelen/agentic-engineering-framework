---
id: T-1908
name: "safe-commands.sh env-var prefix breaks FW_SWITCH_FOCUS bypass — fw work-on
  T-XXX with FW_SWITCH_FOCUS=1 prefix gets blocked because first-token extraction
  returns 'FW_SWITCH_FOCUS=1' instead of 'fw'"
description: >
  safe-commands.sh env-var prefix breaks FW_SWITCH_FOCUS bypass — fw work-on T-XXX
  with FW_SWITCH_FOCUS=1 prefix gets blocked because first-token extraction returns
  'FW_SWITCH_FOCUS=1' instead of 'fw'
