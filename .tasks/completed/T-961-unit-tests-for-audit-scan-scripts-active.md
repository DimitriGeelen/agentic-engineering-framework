---
id: T-961
name: "Unit tests for audit scan scripts (active-task-scan.py, completed-task-scan.py)"
description: >
...
### Agent
- [x] Tests for active-task-scan.py cover compliance, quality, research checks (4 tests)
- [x] Tests for completed-task-scan.py cover episodic, research, AC checks (4 tests)
- [x] All 8 tests pass

## Verification

bats tests/unit/audit_scan.bats
...
### Human
<!-- No human verification needed — deterministic tests.
     Example:
...
### 2026-04-06T13:14:35Z — task-created [task-create-agent]
