---
id: T-2452
name: "F6: fw doctor --quick — project-only fast mode skipping host/network probes
  (T-2441 dogfood; doctor ~72s)"
description: >
  F6: fw doctor --quick — project-only fast mode skipping host/network probes (T-2441
  dogfood; doctor ~72s)
