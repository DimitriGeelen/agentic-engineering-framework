---
id: T-489
name: "End-to-end onboarding test — validate fresh install → init → serve → smoke
  across platforms"
description: >
  Inception: End-to-end onboarding test — validate fresh install → init → serve →
  smoke across platforms
