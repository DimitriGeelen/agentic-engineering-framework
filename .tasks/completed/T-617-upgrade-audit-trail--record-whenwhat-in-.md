...
description: >
  fw upgrade has no audit trail. Cannot answer when upgrade ran or what version upgraded
  from. Add: timestamp in .framework.yaml, upgrade history in .context/audits/upgrades.yaml.
  From T-614 investigation.
