...
components: [agents/bpmn/bpmn.sh, tests/unit/test_bpmn_promote.py, 
      tools/bpmn_promote.py]
related_tasks: []
...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T22:25:09Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=0 (no-signal); 
      ...
      F-AUTONOMY=4 (body:auto-promote-class-eligibility); F3=0 (no-signal); F1=0
