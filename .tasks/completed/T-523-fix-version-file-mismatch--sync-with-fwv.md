...
description: >
  VERSION file had 1.0.0 while bin/fw FW_VERSION was 1.2.6. This causes 'updated from
  v1.2.6 to v1.0.0' regression message when fw update pulls upstream. Fix: update
  VERSION to match FW_VERSION.
