---
id: T-628
name: "Fix long command line breaks — framework outputs and Human AC steps must be
  terminal-safe"
description: >
  Recurring issue: framework commands (tier0 approve, inception decide, Human AC steps)
  produce long lines that break when pasted into terminals. Happened 3+ times with
  cp+chmod chains. Need structural fix: framework-generated commands must be <80 chars
