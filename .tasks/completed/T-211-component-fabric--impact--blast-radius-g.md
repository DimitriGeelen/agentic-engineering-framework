...
description: >
  Implement fw fabric impact (transitive downstream chain) and fw fabric blast-radius
  (commit-scoped impact). Core graph traversal algorithm. Related: T-191, T-208.
