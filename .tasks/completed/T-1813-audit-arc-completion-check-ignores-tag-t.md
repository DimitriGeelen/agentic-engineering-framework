---
id: T-1813
name: "audit arc-completion check ignores tag-tagged tasks — uses constituent_tasks
  only; dispatch-safety arc invisible at 6/6"
description: >
  audit arc-completion check ignores tag-tagged tasks — uses constituent_tasks only;
  dispatch-safety arc invisible at 6/6
