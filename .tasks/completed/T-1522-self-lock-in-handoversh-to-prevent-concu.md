---
id: T-1522
name: "Self-lock in handover.sh to prevent concurrent-write duplicate sections (defense-in-depth
  for T-1520)"
description: >
  Self-lock in handover.sh to prevent concurrent-write duplicate sections (defense-in-depth
  for T-1520)
