...
components: [agents/context/check-heredoc-cmd-sub.sh, C-009, 
      lib/heredoc_guard.py, tests/unit/test_heredoc_cmd_sub_guard.bats]
...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T22:24:50Z'
    ...
    rationale: estimator-fidelity=0 (no-signal); D1=4 (body:structural-gate); 
      D2=0 (no-signal); D3=2 (body:default-change); D4=2 
