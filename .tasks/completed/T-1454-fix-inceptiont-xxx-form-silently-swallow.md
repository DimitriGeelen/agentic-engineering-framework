---
id: T-1454
name: "Fix /inception/T-XXX form silently swallows decide errors (OBS-017, T-1452
  same fix family)"
description: >
  Fix /inception/T-XXX form silently swallows decide errors (OBS-017, T-1452 same
  fix family)
...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T22:24:33Z'
    ...
    scores:
      ...
      F2: 0
    rationale: D1=0 (no-signal); D2=1 (body:log-or-error-line); D3=0 
      (no-signal); D4=0 (no-signal); F-RECALL=0 (no-signal); F-AUTONOMY=3 
