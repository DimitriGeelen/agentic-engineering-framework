---
id: T-1506
name: "RCA — Tier 0 approval self-defeats under duplicate hook registration (.claude/settings.json
  + /root/.claude/settings.json both register check-tier0)"
description: >
  RCA — Tier 0 approval self-defeats under duplicate hook registration (.claude/settings.json
  + /root/.claude/settings.json both register check-tier0)
