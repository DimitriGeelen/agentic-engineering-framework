---
id: T-2458
name: "AEF fw-MCP adoption strategy — consumers unwired + docs shell-only + deferred-tool
  friction (arc-010 headline-mechanic gap)"
description: >
  Inception: AEF fw-MCP adoption strategy — consumers unwired + docs shell-only +
  deferred-tool friction (arc-010 headline-mechanic gap)
