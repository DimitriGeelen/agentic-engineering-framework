---
id: T-2873
name: "flag C remedy was scoped from one version token of nine — v1-conformant is
  a defined term, not a label"
description: >
  flag C remedy was scoped from one version token of nine — v1-conformant is a defined
  term, not a label
