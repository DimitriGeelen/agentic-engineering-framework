---
id: T-660
name: "Fix global install sync — upgrade also syncs bin/fw and lib/ to HOME/.agentic-framework"
description: >
...
### Agent
- [x] `fw upgrade` syncs bin/fw to global install at $HOME/.agentic-framework/bin/fw
- [x] `fw upgrade` syncs lib/*.sh to global install at $HOME/.agentic-framework/lib/
- [x] Global bin/fw matches framework source after upgrade
- [x] Dry-run mode shows what would be synced
...
### 2026-03-28T16:25:21Z — task-created [task-create-agent]
