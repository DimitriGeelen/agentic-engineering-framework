...
description: >
  Add multi-layer defense to prevent Claude Code's built-in EnterPlanMode from bypassing
  framework governance. Layer 1: CLAUDE.md prohibition. Layer 2: PreToolUse hook.
  Layer 3: Gap registration.
...
**Verification-level findings:**
  ...
  1. **l387-sigpipe-risk** (partial, heuristic) @ Verification:line 6
     - evidence: `/opt/999-Agentic-Engineering-Framework/bin/fw doctor 2>&1 | grep -q "All checks passed"`
