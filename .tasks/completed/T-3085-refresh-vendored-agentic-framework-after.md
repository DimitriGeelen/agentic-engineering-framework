---
id: T-3085
name: "refresh vendored .agentic-framework after the T-3077 agents/ change"
description: >
...
# T-3085: refresh vendored .agentic-framework after the T-3077 agents/ change
...
# The self-vendor gate (T-2240) sees no drift. L-387: redirect then grep, never pipe.
bin/fw vendor self --dry-run > .context/working/.t3085-vendor.out 2>&1 && ! grep -q "would sync" .context/working/.t3085-vendor.out
# The vendored copy of the file T-3077 changed matches the framework source byte-for-byte.
cmp -s agents/context/check-project-boundary.sh .agentic-framework/agents/context/check-project-boundary.sh
# The vendored tree carries no uncommitted drift.
...
### 2026-08-18T19:40:28Z — task-created [task-create-agent]
