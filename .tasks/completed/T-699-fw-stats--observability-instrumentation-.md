...
description: >
  Log framework operations to local SQLite, expose fw stats command. Pattern from
  KCP (RFC-0017). Answers 'what do agents actually use?' No equivalent exists today.
  Score: 18/20 (D1:4 D2:5 D3:4 D4:5). Source: T-697 pattern harvest #10.
