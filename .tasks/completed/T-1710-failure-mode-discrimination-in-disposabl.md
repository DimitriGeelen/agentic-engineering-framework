---
id: T-1710
name: "Failure-mode discrimination in disposable test instances — distinguish 'scenario
  triggered as designed' from 'instance is broken'"
description: >
  Failure-mode discrimination in disposable test instances — distinguish 'scenario
  triggered as designed' from 'instance is broken'
