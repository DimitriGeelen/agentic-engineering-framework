---
id: T-1182
name: "Fix G-033: extract fw_cmd helper — replace hardcoded bin/fw in error messages
  with context-aware path"
description: >
  Fix G-033: extract fw_cmd helper — replace hardcoded bin/fw in error messages with
  context-aware path
...
bvp_scores_proposed:
  - ts: '2026-06-11T22:23:42Z'
    ...
    scores:
      ...
      F1: 0
      F2: 0
    rationale: D1=2 (body:concern-ref); D2=1 (body:log-or-error-line); D3=0 
