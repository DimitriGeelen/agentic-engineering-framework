---
id: T-2451
name: "F7: fw doctor segments [project] vs [host] checks — project-health-first +
  one-line project verdict (T-2441 dogfood)"
description: >
  F7: fw doctor segments [project] vs [host] checks — project-health-first + one-line
  project verdict (T-2441 dogfood)
