---
id: T-928
name: "Add unit tests for agents/task-create/update-task.sh"
description: >
...
update-task.sh (805 lines) is the most complex agent script with no tests. Testing help, argument validation, status transitions, and error handling.

## Acceptance Criteria

### Agent
- [x] Test file exists at tests/unit/update_task.bats
- [x] Tests cover help, argument validation, status changes, owner, horizon, tags, invalid values
...
### 2026-04-05T16:19:48Z — task-created [task-create-agent]
