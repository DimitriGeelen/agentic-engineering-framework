---
id: T-1083
name: "Fix post-compact-resume fabric lookup — uses PROJECT_ROOT path, fails silently
  on consumers"
description: >
  Fix post-compact-resume fabric lookup — uses PROJECT_ROOT path, fails silently on
  consumers
