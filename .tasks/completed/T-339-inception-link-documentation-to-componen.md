...
description: >
  Explore how documentation pages (guides, concept explanations, deep-dives) can be
  linked to their corresponding Component Fabric entries, creating bidirectional navigation
  between what-it-is (docs) and where-it-is (code). Use cases: doc page links to fabric
  component, fabric component links to relevant docs, Watchtower shows docs alongside
  component details.
