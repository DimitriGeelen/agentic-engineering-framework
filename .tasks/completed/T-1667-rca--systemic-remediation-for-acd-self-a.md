---
id: T-1667
name: "RCA + systemic remediation for §ACD self-application closure-bias incident
  (3rd repeat)"
description: >
  RCA + systemic remediation for §ACD self-application closure-bias incident (3rd
  repeat)
