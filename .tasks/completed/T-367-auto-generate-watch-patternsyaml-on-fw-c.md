...
description: >
  When .fabric/watch-patterns.yaml doesn't exist, fw context init should generate
  a default from common source patterns (src/**/*.py, **/*.ts, **/*.go, etc). Unblocks
  fw fabric scan for non-framework projects. See R-1 in fabric silent-degradation
  analysis.
