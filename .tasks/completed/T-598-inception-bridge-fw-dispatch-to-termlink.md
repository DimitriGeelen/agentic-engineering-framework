---
id: T-598
name: "Inception: Bridge fw dispatch to TermLink file/remote — replace SSH text pipe
  with native hub routing and file transfer"
description: >
  TermLink already has file send/receive, hub server, and remote commands. But fw
  dispatch only sends JSON text over SSH. Bridge the gap: wire fw bus/dispatch to
  use termlink file send, termlink remote send-file, and termlink hub for cross-machine
  communication. Research why the previous attempt failed, what TermLink capabilities
