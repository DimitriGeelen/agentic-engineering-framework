...
description: >
  Operator surface so humans can review what got auto-deferred. Adds 'fw pickup auto-deferred
  list' subcommand that lists envelopes in .context/pickup/auto-deferred/ with their
  breadcrumb target T-XXX, reason, and deferred_at timestamp.
