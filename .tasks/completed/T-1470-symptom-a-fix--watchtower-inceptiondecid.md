---
id: T-1470
name: "Symptom A fix — Watchtower /inception/decide returns 200 with warning on auto-trigger
  failure (not 500)"
description: >
  Symptom A fix — Watchtower /inception/decide returns 200 with warning on auto-trigger
  failure (not 500)
...
horizon:
tags: []
components: [tests/web/test_inception_decide_hardening.py, 
