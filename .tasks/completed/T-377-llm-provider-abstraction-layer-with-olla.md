...
description: >
  Create web/llm/ package with LLMProvider ABC, OllamaProvider, OpenRouterProvider,
  ProviderManager. Strategy pattern for hot-switching. Refactor ask.py to use provider
  interface. Add openai dependency. Parent: T-375.
