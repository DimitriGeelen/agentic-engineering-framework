---
id: T-2560
name: "corpus gap: boundary-event attachment semantics (attachedToRef, cancelActivity,
  boundaryPos) dropped without WARN mention"
description: >
  arc-014 Spike-2 finding (T-2559): on 832's boundary-events.bpmn the Pass-3 typed-event
  WARN fires for both boundaryEvent nodes but surfaces only kind+binding — the attachment
  semantics (attachedToRef host, cancelActivity interrupting flag, aef:boundaryPos)
...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T22:25:10Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=2 
      ...
      (body:episodic-only); F-AUTONOMY=0 (no-signal); F3=0 (no-signal); F1=2 
      (body:context-fabric-minor); F2=0 (no-signal)
    rubric_sha: e4a00f38e801
---

# T-2560: corpus gap: boundary-event attachment semantics (attachedToRef, cancelActivity, boundaryPos) dropped without WARN mention
...
### 2026-07-19T20:43:03Z — task-created [task-create-agent]
- **Action:** Created task via task-create agent
- **Output:** /opt/999-Agentic-Engineering-Framework/.tasks/active/T-2560-corpus-gap-boundary-event-attachment-sem.md
