---
id: T-1479
name: "T-1479: fw upgrade detects duplicate framework hooks across user-level and
  project-level settings"
description: >
  T-1479: fw upgrade detects duplicate framework hooks across user-level and project-level
  settings
