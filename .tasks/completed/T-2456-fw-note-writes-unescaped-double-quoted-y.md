---
id: T-2456
name: "fw note writes unescaped double-quoted YAML — backslash in note body corrupts
  inbox.yaml + audit does not validate inbox.yaml parse"
description: >
  fw note writes unescaped double-quoted YAML — backslash in note body corrupts inbox.yaml
  + audit does not validate inbox.yaml parse
