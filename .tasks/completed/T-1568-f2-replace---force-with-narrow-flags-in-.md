---
id: T-1568
name: "F2: Replace --force with narrow flags in Watchtower complete-task endpoints
  (RCA + Recommendation gate bypass fix)"
description: >
  F2: Replace --force with narrow flags in Watchtower complete-task endpoints (RCA
  + Recommendation gate bypass fix)
