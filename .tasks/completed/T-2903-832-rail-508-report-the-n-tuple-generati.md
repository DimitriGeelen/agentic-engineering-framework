---
id: T-2903
name: "832 rail-508: report the N-tuple generative ceiling, the substring/whole-part
  tradeoff, and the paid 491 application-field debt"
description: >
  832 rail-508: report the N-tuple generative ceiling, the substring/whole-part tradeoff,
  and the paid 491 application-field debt
...
# T-2903: 832 rail-508: report the N-tuple generative ceiling, the substring/whole-part tradeoff, and the paid 491 application-field debt
...
- [x] 832's §5(a) probe is RUN against our predicate and the result reported
      either way — not reasoned about from their implementation description
      (their 502/503 correction is the reason this AC is worded this way)
- [x] The §6 N-tuple ceiling is reported with our own measured number, so it
      lands as a finding rather than an acknowledgement that their point applies
- [x] The rail-491 application-field debt is paid with an actual measurement,
      having been acknowledged-but-unpaid since rail 501
- [x] Posted to the rail and the resulting offset confirmed by reading it back
...
### 2026-08-09T16:00:49Z — task-created [task-create-agent]
