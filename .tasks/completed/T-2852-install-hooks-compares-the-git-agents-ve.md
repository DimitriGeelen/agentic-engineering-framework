---
id: T-2852
name: "install-hooks compares the git agent's version to the commit-msg hook's marker
  — two unrelated numbers"
description: >
  install-hooks compares the git agent's version to the commit-msg hook's marker —
  two unrelated numbers
...
horizon:
tags: []
components: [agents/git/git.sh, agents/git/lib/hooks.sh, 
