---
id: T-1135
name: "Persistent TermLink agent sessions — always-listening receptionist per project,
  resume-flow health check, cleanup exemption, cross-agent specialist network"
description: >
  Inception: Persistent TermLink agent sessions — always-listening receptionist per
  project, resume-flow health check, cleanup exemption, cross-agent specialist network
