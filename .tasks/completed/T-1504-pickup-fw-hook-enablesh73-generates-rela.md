---
id: T-1504
name: "Pickup: fw hook-enable.sh:73 generates relative-path hook commands that fail
  when shell cwd != project root (680 silent occurrences in one downstream project)
