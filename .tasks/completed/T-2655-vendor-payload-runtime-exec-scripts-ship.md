---
id: T-2655
name: "Vendor payload: runtime-exec scripts ship 100644 - chmod+x secret-scan.sh master-guard.sh
  (832 T-276 finding 1)"
description: >
  832's live re-vendor (rail 269, their T-276): secret-scan.sh + master-guard.sh are
  100644 in git; installed pre-commit requires -x so fresh vendors silently skip the
...
horizon: null
tags: []
components: [agents/git/lib/master-guard.sh, agents/git/lib/secret-scan.sh]
related_tasks: []
...
last_update: 2026-07-28T11:42:03Z
date_finished: 2026-07-28T11:42:03Z
...
# T-2655: Vendor payload: runtime-exec scripts ship 100644 - chmod+x secret-scan.sh master-guard.sh (832 T-276 finding 1)
...
### 2026-07-28T10:20:51Z — task-created [task-create-agent]
...
- **Scan ID:** R-957a094b
- **Timestamp:** 2026-07-28T11:42:05Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-07-28T11:42:03Z — status-update [task-update-agent]
