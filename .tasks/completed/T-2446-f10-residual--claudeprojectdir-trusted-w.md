---
id: T-2446
name: "F10 residual — CLAUDE_PROJECT_DIR trusted without cwd-consistency check (daemon-inheritance
  leak)"
description: >
  F10 residual — CLAUDE_PROJECT_DIR trusted without cwd-consistency check (daemon-inheritance
  leak)
...
horizon:
tags: []
components: [bin/fw, tests/unit/t2446_project_root_cwd_consistency.bats]
related_tasks: []
...
date_finished: 2026-06-21T10:35:12Z
...
- **Scan ID:** R-e938d3c2
- **Timestamp:** 2026-06-21T10:35:15Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-06-21T10:35:12Z — status-update [task-update-agent]
