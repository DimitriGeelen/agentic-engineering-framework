---
id: T-630
name: "Universal task gate — close Bash, Agent, and TermLink bypass paths that violate
  core principle"
description: >
  Inception: Universal task gate — close Bash, Agent, and TermLink bypass paths that
  violate core principle
