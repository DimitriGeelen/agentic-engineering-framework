---
id: T-2285
name: "termlink dispatch run.sh — discriminate framework-self vs consumer when setting FRAMEWORK_ROOT (OBS-062 substrate fix)"
description: >
  termlink dispatch run.sh — discriminate framework-self vs consumer when setting FRAMEWORK_ROOT (OBS-062 substrate fix)
...
last_update: 2026-06-09T11:44:14Z
