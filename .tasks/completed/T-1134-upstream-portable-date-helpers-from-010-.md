---
id: T-1134
name: "Upstream portable date helpers from 010-termlink — lib/compat.sh _date_to_epoch
  + episodic verification"
description: >
  Upstream portable date helpers from 010-termlink — lib/compat.sh _date_to_epoch
  + episodic verification
