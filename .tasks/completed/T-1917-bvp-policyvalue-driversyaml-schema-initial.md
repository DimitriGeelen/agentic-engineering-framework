---
id: T-1917
name: "BVP T-NEW-2: policy/value-drivers.yaml schema + initial content (D1-D4 weights
  9/7/5/3, free-driver section, auto_promote off)"
description: >
  Create policy/ directory and policy/value-drivers.yaml with protected D1-D4 (weights
  9/7/5/3), free_drivers: [], and auto_promote disabled by default. First slice of
  arc-006 BVP build (T-NEW-2 from HANDOFF-value-prioritisation-2026-05-15).
...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T22:24:49Z'
    ...
    rationale: estimator-fidelity=0 (no-signal); D1=0 (no-signal); D2=4 
      (body:fw-audit-or-doctor); D3=0 (no-signal); D4=0 (no-signal); F-RECALL=2 
