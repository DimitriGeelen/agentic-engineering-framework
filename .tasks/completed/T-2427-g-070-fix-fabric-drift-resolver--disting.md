---
id: T-2427
name: "G-070 fix: fabric drift resolver — distinguish data-artifact deps from real
  drift (target exists on disk → silent; missing → stale)"
description: >
  G-070 fix: fabric drift resolver — distinguish data-artifact deps from real drift
  (target exists on disk → silent; missing → stale)
