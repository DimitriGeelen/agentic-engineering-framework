---
id: T-2488
name: "RCA + fix: bare dispatch worker hits 'Prompt is too long' on trivial task (T-2484
  delegation reliability)"
description: >
  RCA + fix: bare dispatch worker hits 'Prompt is too long' on trivial task (T-2484
  delegation reliability)
...
horizon: null
tags: []
components: [lib/ollama_loop.py, lib/resolver.py, lib/spawn.py, lib/termlink_worker.py]
related_tasks: []
...
last_update: 2026-09-03T23:58:56Z
date_finished: 2026-09-03T23:58:56Z
...
cost_estimate_proposed:
  ...
  - ts: '2026-08-17T12:36:21Z'
    ...
    rationale: blast_radius=? (no-components-UNMEASURED-not-zero); tier=2 
      (workflow:build); effort=8 (lines=226,acs=6)
    rubric_sha: e4a00f38e801
bvp_scores_proposed:
  - ts: '2026-08-16T22:25:07Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=2 
      (body:telemetry-or-audit-entry); D3=5 (body:new-collab-mode); D4=3 
...
- **Scan ID:** R-baa4e397
- **Timestamp:** 2026-09-03T23:58:58Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-09-03T23:58:56Z — status-update [task-update-agent]
