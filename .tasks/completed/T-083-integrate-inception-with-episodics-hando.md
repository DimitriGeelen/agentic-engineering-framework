...
description: >
  Update episodic.sh to extract inception decisions and assumption references. Update handover.sh to show pending inception tasks section. Update CLAUDE.md workflow types table and command reference. Update FRAMEWORK.md with inception workflow type.
status: work-completed
workflow_type: build
owner: agent
created: 2026-02-16T21:06:23Z
last_update: 2026-02-16T21:15:15Z
