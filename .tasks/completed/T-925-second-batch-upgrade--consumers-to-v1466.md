---
id: T-925
name: "Second batch upgrade — consumers to v1.4.664"
description: >
...
Framework advanced from v1.4.651 to v1.4.664 during this session. All consumers need another upgrade.

## Acceptance Criteria

### Agent
- [x] All 11 consumers upgraded to v1.4.664
- [x] fw doctor shows no version warnings
...
### 2026-04-05T16:13:07Z — task-created [task-create-agent]
