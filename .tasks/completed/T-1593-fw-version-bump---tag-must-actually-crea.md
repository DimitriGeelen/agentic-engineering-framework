---
id: T-1593
name: "fw version bump --tag must actually create annotated tag (T-1591/T-1592 Prevention
  #2)"
description: >
  fw version bump --tag must actually create annotated tag (T-1591/T-1592 Prevention
  #2)
