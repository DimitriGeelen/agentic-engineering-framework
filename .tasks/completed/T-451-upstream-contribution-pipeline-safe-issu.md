---
id: T-451
name: "Upstream contribution pipeline: safe issue/PR creation from field installations
  to framework repo"
description: >
  Inception: Upstream contribution pipeline: safe issue/PR creation from field installations
  to framework repo
