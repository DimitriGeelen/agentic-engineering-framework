...
description: >
  fw doctor flagged: 'fw prompt' subcommand missing from CLAUDE.md Quick Reference table. One-line addition under Vendor framework row. Cites the prompt register (create/list/show/copy/edit/delete/backfill-qid).
...
last_update: 2026-04-18T23:22:08Z
