---
id: T-3156
name: "vendored .agentic-framework/bin/fw is committed non-executable — consumers
  get exit 126"
description: >
  vendored .agentic-framework/bin/fw is committed non-executable — consumers get exit
  126
...
last_update: '2026-08-26T11:15:14Z'
date_finished:
...
cost_estimate_proposed:
  - ts: '2026-08-26T11:15:08Z'
    ...
    rationale: blast_radius=? (no-components-UNMEASURED-not-zero); tier=2 
      (workflow:build); effort=8 (lines=218,acs=6)
    rubric_sha: e4a00f38e801
bvp_scores_proposed:
  - ts: '2026-08-26T11:15:14Z'
    estimator: bvp-estimator-v1-heuristic
    scores:
      D1: 4
      D2: 2
