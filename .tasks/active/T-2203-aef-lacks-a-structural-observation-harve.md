---
id: T-2203
name: "AEF lacks a structural-observation harvester from dispatched workers back to the framework repo"
description: >
  Workers dispatched via fw termlink dispatch can observe framework-level gaps (T-2200: corrupted-config diagnostic buried; T-2202: FRAMEWORK_ROOT env-leak), but there is no mechanism for those observations to bubble back to /opt/999-Agentic-Engineering-Framework. fw pickup primitives exist but are generic message bus, not wired to upstream-framework-tagged observations. Inception: harvester contract — workers file local inception, parent polls; OR workers fw pickup send; OR dispatch contract changes.
...
last_update: 2026-06-04T07:57:58Z
date_finished: null
