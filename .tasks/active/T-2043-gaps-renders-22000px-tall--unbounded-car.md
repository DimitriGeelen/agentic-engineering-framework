...
description: >
  /gaps renders 22,278px (card-list: {% for g in gaps %}<article> with nested details). 6th instance of the unbounded-page class found by the T-2042 exhaustive height probe. Fix: cap inline + collapse overflow <details>, like T-2040 /inception.
...
last_update: 2026-05-25T14:52:39Z
date_finished: null
