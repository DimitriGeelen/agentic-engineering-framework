---
id: T-100060
name: "audit cascade prevention — suppress recursive task creation"
description: >
...
# T-100060: audit cascade prevention — suppress recursive task creation

## Context

Root cause: `audit --emit-tasks` creates tasks from WARN/FAIL findings. Newly-created tasks lack `## Updates` sections (they're fresh), triggering the same "missing Updates" warning → audit creates tasks about those tasks → exponential recursion. T-100025 deleted 28 cascade tasks; this session generated 59+ more (T-100000-T-100059). Need systemic prevention, not manual cleanup.
...
### 2026-07-03T06:34:34Z — task-created [task-create-agent]
