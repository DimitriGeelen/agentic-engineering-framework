---
id: T-100184
name: "Audit WARN — CTL-012: Completed task T-2457 has unchecked AC"
description: >
  Audit WARN — CTL-012: Completed task T-2457 has unchecked AC

status: captured
workflow_type: build
audit_severity: warn
audit_finding_hash: faab46ea2e89534e44b01f8b8fcd6bbe85f093f5
...
# T-100184: Audit WARN — CTL-012: Completed task T-2457 has unchecked AC
## Trigger

Audit run: 2026-07-04T17:05:40Z
Finding: CTL-012: Completed task T-2457 has unchecked AC

## Finding

```
CTL-012: Completed task T-2457 has unchecked AC
```
...
bin/fw audit 2>&1 | grep -q "CTL-012: Completed task T-2457 has unchecked AC" && exit 1 || exit 0

## Updates

### 2026-07-04T17:05:40Z — audit-emit-task [audit-agent]
- **Action:** Created by audit --emit-tasks
- **Finding:** warn: CTL-012: Completed task T-2457 has unchecked AC
- **Context:** Auto-generated task for audit finding hash faab46ea2e89534e44b01f8b8fcd6bbe85f093f5
