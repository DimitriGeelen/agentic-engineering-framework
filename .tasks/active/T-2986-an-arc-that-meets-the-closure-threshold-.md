---
id: T-2986
name: "an arc that meets the closure threshold but lacks an anchor Recommendation
  is silently excluded"
description: >
  an arc that meets the closure threshold but lacks an anchor Recommendation is silently
  excluded
