---
id: T-2588
name: "handover --checkpoint commits but never pushes checkpoint commit"
description: >
  fw handover --checkpoint auto-commits the checkpoint handover but has no push leg
  — checkpoint commits accumulate locally until session end; if the session dies (or
...
# T-2588: handover --checkpoint commits but never pushes checkpoint commit
...
### 2026-07-21T12:27:16Z — task-created [task-create-agent]
