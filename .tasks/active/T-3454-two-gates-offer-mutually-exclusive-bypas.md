---
id: T-3454
name: "two gates offer mutually exclusive bypass contracts — focus-drift requires
  an FW_SWITCH_FOCUS=1 env prefix that the partial-complete gate then refuses because
  an assignment prefix is not on the read-only allowlist"
description: >
  two gates offer mutually exclusive bypass contracts — focus-drift requires an FW_SWITCH_FOCUS=1
...
cost_estimate_proposed:
  - ts: '2026-09-24T23:15:13Z'
    ...
    rationale: blast_radius=? (no-components-UNMEASURED-not-zero); tier=2 
      (workflow:build); effort=8 (lines=291,acs=8)
    rubric_sha: e4a00f38e801
bvp_scores_proposed:
  - ts: '2026-09-24T23:15:34Z'
    estimator: bvp-estimator-v1-heuristic
    scores:
      D1: 4
      D2: 4
