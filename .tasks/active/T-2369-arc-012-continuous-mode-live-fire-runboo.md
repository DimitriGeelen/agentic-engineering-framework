---
id: T-2369
name: "arc-012 continuous-mode live-fire runbook — operator end-to-end test via claude-fw
  with lowered FW_CONTEXT_WINDOW"
description: >
  arc-012 continuous-mode live-fire runbook — operator end-to-end test via claude-fw
  with lowered FW_CONTEXT_WINDOW
...
bvp_scores_proposed:
  - ts: '2026-08-16T22:24:09Z'
    ...
    rationale: Discard fidelity=0 (no-signal); Loop closure (conditional)=0 
      (no-signal); D1=4 (body:structural-gate); D2=0 (no-signal); D3=4 
      (body:framework-level-ux); D4=2 (body:env-class-handled); F-RECALL=1 
