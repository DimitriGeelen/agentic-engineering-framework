...
description: >
  T-2138 V2 sibling to T-2139. Add review-link-homework pattern to agents/audit/reviewer/static_scan.py catalogue. Emits CONCERN on a [REVIEW] AC whose Steps contain the absence-of-URL homework patterns. Provides catch-before-handoff backstop so the agent self-corrects before T-2139's gate fires.
