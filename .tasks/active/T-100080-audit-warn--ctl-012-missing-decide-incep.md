---
id: T-100080
name: "Audit WARN — CTL-012-MISSING-DECIDE: Inception task T-1902 flipped without decide c..."
description: >
...
workflow_type: build
audit_severity: warn
audit_finding_hash: 7d5582c667ceb6e91cecefd5c68de2b4e8955565
...
Audit run: 2026-07-03T07:36:18Z
Finding: CTL-012-MISSING-DECIDE: Inception task T-1902 flipped without decide ceremony

## Finding

```
CTL-012-MISSING-DECIDE: Inception task T-1902 flipped without decide ceremony
```

Mitigation: Auto-tick markers present but ## Decision section empty — run: fw inception decide T-1902 go
...
bin/fw audit 2>&1 | grep -q "CTL-012-MISSING-DECIDE: Inception task T-1902 flipped without decide ceremony" && exit 1 || exit 0

## Updates

### 2026-07-03T07:36:18Z — audit-emit-task [audit-agent]
