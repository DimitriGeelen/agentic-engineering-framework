---
id: T-2463
name: "fix: active-task gate resolves PROJECT_ROOT to main repo in worktree sessions
  (reads wrong focus.yaml) — OBS-080"
description: >
  fix: active-task gate resolves PROJECT_ROOT to main repo in worktree sessions (reads
  wrong focus.yaml) — OBS-080
...
date_finished: 2026-07-06T13:02:03Z
...
- **Scan ID:** R-3d1bd8ff
- **Timestamp:** 2026-07-06T13:02:23Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** yes
- **Findings:** none
...
- **Layer-1 escalations:** 1
  1. **external-publish** (high) — External publish or release
     - matched: `merge to master`

### 2026-07-06T13:02:03Z — status-update [task-update-agent]
