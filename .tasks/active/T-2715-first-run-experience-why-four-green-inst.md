...
last_update: 2026-08-01T23:03:06Z
date_finished:
...
- **IW-16: What exactly is deficient about the existing `fw onboarding skip`?**
  confidence: 2
  disposition: RESOLVED — **NOTHING. F-8 RETRACTED (operator 2026-08-02, agent-suggested).** The verb is correctly surfaced to its actual audience; no bypass work is needed. One filed residual carried to the onboarding-scenario arc (below).
