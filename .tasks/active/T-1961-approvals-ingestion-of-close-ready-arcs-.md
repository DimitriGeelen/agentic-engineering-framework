...
description: >
  T-1959 build child B: add 'ARC CLOSURE — ready for review (N)' section to /approvals. Source: arcs in-progress with >=0.80 completion AND a recommendation block on anchor task. Click-through navigates to /arcs/<slug>/review (read) or /close (act).
...
last_update: 2026-05-20T17:56:41Z
date_finished: null
