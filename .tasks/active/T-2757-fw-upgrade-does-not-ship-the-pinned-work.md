...
last_update: '2026-08-03T10:15:12Z'
date_finished:
...
**Rationale:** Evidence gap: have not yet established whether do_vendor/fw upgrade copies vendor/designer to consumers, whether the 903KB HTML is appropriate to vendor per-consumer, or where a consumer is expected to obtain the artifact. Investigation dispatched to a TermLink worker; recommendation to be replaced with GO/NO-GO once the vendor path and artifact-source question are answered.
