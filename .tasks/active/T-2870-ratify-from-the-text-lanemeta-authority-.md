---
id: T-2870
name: "ratify from the text: laneMeta authority class + workflowMeta kind= carrier
  gap in frozen mapping-v1"
description: >
  ratify from the text: laneMeta authority class + workflowMeta kind= carrier gap
  in frozen mapping-v1
