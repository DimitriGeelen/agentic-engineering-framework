...
description: >
  T-1959 build child C: mirror `fw task review T-XXX` shape for arcs. Emits /arcs/<slug>/review URL + QR code. Under $CLAUDECODE=1 the agent runs this instead of pasting raw CLI close commands (T-1671 sovereignty preserved).
...
last_update: 2026-05-20T17:57:02Z
date_finished: null
