---
id: T-3191
name: "bats-dead-negation-lint is wired into no gate, so the 107th inert assertion lands unchallenged"
description: >
  T-3138 measured the class, swept 106 inert '! cmd' assertions, and shipped tools/bats-dead-negation-lint.py. Nothing runs it: no audit section, no fw test lint, no cron, no hook. T-3190 reintroduced the class two days later in a brand-new suite and it went green; only mutation testing exposed it. The sweep cleaned the existing sites but left no rail against the next one.
...
last_update: 2026-08-27T07:40:03Z
date_finished: null
