---
id: T-100179
name: "Audit WARN — CTL-012: Completed task T-2437 has unchecked AC"
description: >
  Audit WARN — CTL-012: Completed task T-2437 has unchecked AC

status: captured
workflow_type: build
audit_severity: warn
audit_finding_hash: 001a8d423b12407c7c1c771a84cc704711753ef8
...
# T-100179: Audit WARN — CTL-012: Completed task T-2437 has unchecked AC
## Trigger

Audit run: 2026-07-04T17:04:55Z
Finding: CTL-012: Completed task T-2437 has unchecked AC

## Finding

```
CTL-012: Completed task T-2437 has unchecked AC
```
...
bin/fw audit 2>&1 | grep -q "CTL-012: Completed task T-2437 has unchecked AC" && exit 1 || exit 0

## Updates

### 2026-07-04T17:04:55Z — audit-emit-task [audit-agent]
- **Action:** Created by audit --emit-tasks
- **Finding:** warn: CTL-012: Completed task T-2437 has unchecked AC
- **Context:** Auto-generated task for audit finding hash 001a8d423b12407c7c1c771a84cc704711753ef8
