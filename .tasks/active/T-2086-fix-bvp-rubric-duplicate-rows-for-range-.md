---
id: T-2086
name: "fix /bvp rubric duplicate rows for range scores (1–2 expands to two identical
  rows)"
description: >
...
bvp_scores_proposed:
  - ts: '2026-06-11T22:23:31Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=2 
      (body:default-change); D4=2 (body:env-class-handled); F-RECALL=5 
      (body/components:retrieval-layer); F-ORCH=0 (no-signal); F3=1 
