...
description: >
  Map the task-creation process (capture → classification → BVP estimation → confirmation → activation; create-task.sh + estimator worker + fw work-on) as a corpus map + conformance rail. Third of the package's four worst-regression processes (T-2662 gap 6). Gated on the tier0-escalation P4 test outcome.
...
last_update: 2026-07-28T16:20:18Z
date_finished: null
