...
description: >
  Map the knowledge-leveling process (capture → universal-vs-framework classification → graduation criteria → level promotion → ratification; learnings/practices pipeline) as a corpus map + conformance rail. Fourth of the package's four worst-regression processes (T-2662 gap 6). Gated on the tier0-escalation P4 test outcome.
...
last_update: 2026-07-28T16:20:57Z
date_finished: null
