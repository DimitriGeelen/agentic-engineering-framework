...
components: [tests/playwright/test_command_palette.py, 
      tests/playwright/test_nav_layouts.py, tests/unit/test_command_palette.py, 
      tests/unit/test_nav_layouts.py, web/blueprints/settings.py, web/shared.py, 
      web/static/command-palette.js, web/templates/appearance.html, 
