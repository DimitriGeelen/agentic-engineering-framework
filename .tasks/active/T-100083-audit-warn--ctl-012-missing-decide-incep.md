---
id: T-100083
name: "Audit WARN — CTL-012-MISSING-DECIDE: Inception task T-2000 flipped without decide c..."
description: >
...
Audit run: 2026-07-03T07:37:23Z
Finding: CTL-012-MISSING-DECIDE: Inception task T-2000 flipped without decide ceremony

## Finding

```
CTL-012-MISSING-DECIDE: Inception task T-2000 flipped without decide ceremony
```

Mitigation: Auto-tick markers present but ## Decision section empty — run: fw inception decide T-2000 go
...
bin/fw audit 2>&1 | grep -q "CTL-012-MISSING-DECIDE: Inception task T-2000 flipped without decide ceremony" && exit 1 || exit 0

## Updates

### 2026-07-03T07:37:23Z — audit-emit-task [audit-agent]
