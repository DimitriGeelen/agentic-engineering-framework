---
id: T-2517
name: "PreToolUse hook: block manual write creating completed/T-X while active/T-X
  exists (T-2121 prong 1)"
description: >
  T-2121 GO prong 1: PreToolUse hook on Write|Edit refuses creating .tasks/completed/T-NNNN-*.md
  while .tasks/active/T-NNNN-*.md exists (and vice-versa), with a bypass for the legitimate
