...
description: >
  Crude load-adaptive provisioning admission control (D5 bound 2): defer/deny provisioning when host headroom is low (loadavg/headroom threshold v1). Full mem/disk/cpu/net governor is a follow-on. Serves G4. Retrofits the load-62 incident.
