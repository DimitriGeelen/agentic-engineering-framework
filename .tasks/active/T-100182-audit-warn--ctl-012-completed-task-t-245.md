---
id: T-100182
name: "Audit WARN — CTL-012: Completed task T-2453 has unchecked AC"
description: >
  Audit WARN — CTL-012: Completed task T-2453 has unchecked AC

status: captured
workflow_type: build
audit_severity: warn
audit_finding_hash: 322c197b3067b239e0de04ef4b38081efc7aacb8
...
# T-100182: Audit WARN — CTL-012: Completed task T-2453 has unchecked AC
## Trigger

Audit run: 2026-07-04T17:05:23Z
Finding: CTL-012: Completed task T-2453 has unchecked AC

## Finding

```
CTL-012: Completed task T-2453 has unchecked AC
```
...
bin/fw audit 2>&1 | grep -q "CTL-012: Completed task T-2453 has unchecked AC" && exit 1 || exit 0

## Updates

### 2026-07-04T17:05:23Z — audit-emit-task [audit-agent]
- **Action:** Created by audit --emit-tasks
- **Finding:** warn: CTL-012: Completed task T-2453 has unchecked AC
- **Context:** Auto-generated task for audit finding hash 322c197b3067b239e0de04ef4b38081efc7aacb8
