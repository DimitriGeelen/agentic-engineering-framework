...
# T-2429: Pickup: Worktree-aware fw resolution: partially-tracked vendored framework breaks fw inside git worktrees (finalize/reviewer/merge) (from termlink)
