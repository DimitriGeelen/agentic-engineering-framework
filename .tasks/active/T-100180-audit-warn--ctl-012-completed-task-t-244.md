---
id: T-100180
name: "Audit WARN — CTL-012: Completed task T-2449 has unchecked AC"
description: >
  Audit WARN — CTL-012: Completed task T-2449 has unchecked AC

status: captured
workflow_type: build
audit_severity: warn
audit_finding_hash: 39113b56dc3c8c224e31d9c97ede784ec5b4600f
...
# T-100180: Audit WARN — CTL-012: Completed task T-2449 has unchecked AC
## Trigger

Audit run: 2026-07-04T17:05:04Z
Finding: CTL-012: Completed task T-2449 has unchecked AC

## Finding

```
CTL-012: Completed task T-2449 has unchecked AC
```
...
bin/fw audit 2>&1 | grep -q "CTL-012: Completed task T-2449 has unchecked AC" && exit 1 || exit 0

## Updates

### 2026-07-04T17:05:04Z — audit-emit-task [audit-agent]
- **Action:** Created by audit --emit-tasks
- **Finding:** warn: CTL-012: Completed task T-2449 has unchecked AC
- **Context:** Auto-generated task for audit finding hash 39113b56dc3c8c224e31d9c97ede784ec5b4600f
