...
components: [tests/playwright/test_shortcuts_overlay.py, 
      tests/unit/test_shortcuts_overlay.py, web/static/command-palette.js, 
      web/static/shortcuts-overlay.js, web/templates/base.html]
