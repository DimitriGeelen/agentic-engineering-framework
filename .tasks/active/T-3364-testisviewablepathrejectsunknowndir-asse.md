---
id: T-3364
name: "test_is_viewable_path_rejects_unknown_dir asserts the pre-T-2281 contract for
  README.md"
description: >
  The assertion 'assert not is_viewable_path(README.md)  # repo-root, not under any
  prefix' encodes the contract T-2281 (2026-06-09) deliberately superseded: web/shared.py:582
  carries an explicit ROOT_FILES allowlist so depth-0 root files bypass the prefix+extension
  checks. The code is right; the test is stale. T-2281 shipped test_auto_link_root_and_articles.py
  asserting the NEW contract and left this contradicting one in place. Red ~3.2 months,
...
# T-3364: test_is_viewable_path_rejects_unknown_dir asserts the pre-T-2281 contract for README.md
...
### 2026-09-15T16:56:32Z — task-created [task-create-agent]
