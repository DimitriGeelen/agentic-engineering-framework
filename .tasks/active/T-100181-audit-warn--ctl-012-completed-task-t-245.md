---
id: T-100181
name: "Audit WARN — CTL-012: Completed task T-2452 has unchecked AC"
description: >
  Audit WARN — CTL-012: Completed task T-2452 has unchecked AC

status: captured
workflow_type: build
audit_severity: warn
audit_finding_hash: f3530a4d15bc6d54c5c90f0e5aae0784332eb636
...
# T-100181: Audit WARN — CTL-012: Completed task T-2452 has unchecked AC
## Trigger

Audit run: 2026-07-04T17:05:13Z
Finding: CTL-012: Completed task T-2452 has unchecked AC

## Finding

```
CTL-012: Completed task T-2452 has unchecked AC
```
...
bin/fw audit 2>&1 | grep -q "CTL-012: Completed task T-2452 has unchecked AC" && exit 1 || exit 0

## Updates

### 2026-07-04T17:05:13Z — audit-emit-task [audit-agent]
- **Action:** Created by audit --emit-tasks
- **Finding:** warn: CTL-012: Completed task T-2452 has unchecked AC
- **Context:** Auto-generated task for audit finding hash f3530a4d15bc6d54c5c90f0e5aae0784332eb636
