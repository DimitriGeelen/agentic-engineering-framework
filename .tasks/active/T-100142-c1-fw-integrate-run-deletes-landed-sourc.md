...
last_update: 2026-07-04T12:39:39Z
date_finished:
...
git show origin/master:lib/integrate.py | grep -q "_cleanup_branch"
git show origin/master:lib/integrate.py | grep -q "keep_branch"
git show origin/master:tests/unit/t100142_integrate_run_branch_cleanup.bats | grep -q "never force-deleted"
git show origin/master:bin/fw | grep -q -- "--keep-branch"
