...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --force|-f)
            ...
            FORCE=true; SKIP_SOVEREIGNTY=true; SKIP_AC=true; SKIP_VERIFICATION=true; SKIP_HUMAN_OWNERSHIP=true; SKIP_RECOMMENDATION=true; SKIP_RCA=true; SKIP_EVOLUTION=true; SCOPE_REDUCTION_ACK="--force bypass"
            shift ;;
        -h|--help)
