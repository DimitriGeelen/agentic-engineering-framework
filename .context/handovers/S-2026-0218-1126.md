...
Session worked on: inbox: Scope-check gap feedback from sprechloop (G-004); T-147 (Fix G-002 — detect untracked handover open questions in audi); T-146 (Fix G-001 — fw init generic provider now wires Claude Code h). Plus 1 more commit(s).
