...
Session worked on: T-309 (Completion artifacts); T-309 (Fix help text (DIM undefined) + verification SIGPIPE); T-309 (Deprecate fw setup — alias to fw init). Plus 2 more commit(s).
