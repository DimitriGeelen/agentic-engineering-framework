...
Task id for all work: T-3411. Round 4 of 5.

This is round 4 of 5. Round 3 already ran and its results are on
disk. READ BOTH BEFORE YOU START, and treat them as the baseline this round is
measured against:

  docs/reports/SEQ-T3411/r3-review.md              (round 3's review report)
  docs/reports/SEQ-T3411/r3-procasfit-handback.md  (what was actually done after it)

Your job this round is NOT to repeat round 3. Specifically:
  - For every "Expected effect" prediction in round 3's findings table,
  ...
  - Items round 3 classified and the procAsFit round then acted on: check
    whether the action landed, and whether the predicted effect followed.
  - Items round 3 left as INVESTIGATE: try to close them with the data
    that round said would decide.
  - Do not re-propose anything round 3's handback records as rejected,
