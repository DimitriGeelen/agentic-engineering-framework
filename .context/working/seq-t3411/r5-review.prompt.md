...
Task id for all work: T-3411. Round 5 of 5.

This is round 5 of 5. Round 4 already ran and its results are on
disk. READ BOTH BEFORE YOU START, and treat them as the baseline this round is
measured against:

  docs/reports/SEQ-T3411/r4-review.md              (round 4's review report)
  docs/reports/SEQ-T3411/r4-procasfit-handback.md  (what was actually done after it)

Your job this round is NOT to repeat round 4. Specifically:
  - For every "Expected effect" prediction in round 4's findings table,
  ...
  - Items round 4 classified and the procAsFit round then acted on: check
    whether the action landed, and whether the predicted effect followed.
  - Items round 4 left as INVESTIGATE: try to close them with the data
    that round said would decide.
  - Do not re-propose anything round 4's handback records as rejected,
