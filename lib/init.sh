...
GYAML
    ...
    echo ""
    echo -e "  ${BOLD}3. Existing project${NC} — register your codebase:"
    echo -e "     fw fabric register src/main.ts"
    echo -e "     fw fabric drift"
    echo ""
    echo -e "  ${BOLD}4. Dashboard${NC} — see your project at a glance:"
    echo -e "     fw serve"
    echo ""
