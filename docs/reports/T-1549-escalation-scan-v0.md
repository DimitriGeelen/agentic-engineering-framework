...
**Run:** 2026-07-03T03:23:02.145248+00:00
**Corpus:** 2169 completed tasks
**Bug-class identified:** 358 (16%)

## H1 — Bug-class tasks with no `## RCA` section

**Flagged:** 290 / 358 bug-class tasks (81%)
...
- `T-2351-arc-close-form-pre-population--same-mech` — Arc close form pre-population — same mechanic as task/inception ## Recommendatio
- `T-2379-refresh-arc-012-live-fire-runbook-t-2377` — refresh arc-012 live-fire runbook: T-2377 gauge fix + interactive-not-bgjob cave
- `T-2398-fix-obs-076-selfvendor-find-must-prune-n` — Fix OBS-076: _self_vendor_* find must prune node_modules/__pycache__ (phantom pr

## H2 — Learning IDs referenced across ≥3 tasks within 30 days

- `P-011` — referenced by 904 tasks: T-100025-audit-cascade-cleanup---delete-recursive, T-100025-audit-cascade-cleanup---delete-recursive, T-1101-inception-fw-inception-decide-silent---f, T-1101-inception-fw-inception-decide-silent---f, T-1101-inception-fw-inception-decide-silent---f …
- `L-387` — referenced by 742 tasks: T-100025-audit-cascade-cleanup---delete-recursive, T-100025-audit-cascade-cleanup---delete-recursive, T-1828-github-mirror-stalled--version-tag-reset, T-1851-deprecate-constituenttasks-field-t-new-4, T-1852-lifecycle-state-machine-add-draft--aband …
- `L-291` — referenced by 504 tasks: T-100025-audit-cascade-cleanup---delete-recursive, T-1518-approvals-page-surface-deferred-inceptio, T-1521-extend-fw-doctor-vendor-drift-glob-to-co, T-1522-self-lock-in-handoversh-to-prevent-concu, T-1523-update-tasksh-git-stage-both-sides-of-ac …
- `L-398` — referenced by 307 tasks: T-100025-audit-cascade-cleanup---delete-recursive, T-1887-ship-t-1886-rca-candidate-a--task-templa, T-1887-ship-t-1886-rca-candidate-a--task-templa, T-1887-ship-t-1886-rca-candidate-a--task-templa, T-1887-ship-t-1886-rca-candidate-a--task-templa …
- `P-010` — referenced by 173 tasks: T-1101-inception-fw-inception-decide-silent---f, T-1101-inception-fw-inception-decide-silent---f, T-1101-inception-fw-inception-decide-silent---f, T-1101-inception-fw-inception-decide-silent---f, T-1101-inception-fw-inception-decide-silent---f …
...
- `L-364` — referenced by 36 tasks: T-1720-reviewer-audit-cron-silent-failure-5-day, T-1720-reviewer-audit-cron-silent-failure-5-day, T-1766-render-surface-human-ac-gate--block-work, T-1766-render-surface-human-ac-gate--block-work, T-1767-fix-escalation-scan-v05-cron-deploy-gap- …
...
- `L-408` — referenced by 27 tasks: T-1942-fw-doctor-cron-registrygenerated-drift-c, T-1944-extract-cron-drift-python-heredoc-to-lib, T-1944-extract-cron-drift-python-heredoc-to-lib, T-1944-extract-cron-drift-python-heredoc-to-lib, T-1944-extract-cron-drift-python-heredoc-to-lib …
- `L-399` — referenced by 25 tasks: T-1895-template--claudemd-reviewer-example-for-, T-1908-safe-commandssh-env-var-prefix-breaks-fw, T-1908-safe-commandssh-env-var-prefix-breaks-fw, T-1983-go-scope-traceability--inception-decisio, T-1983-go-scope-traceability--inception-decisio …
...
| Metric | Value |
|---|---|
| Total completed tasks | 2169 |
| Bug-class tasks | 358 (16%) |
| H1 flagged | 290 |
| H2 repeat-learning patterns | 117 |
| H3 flagged (strongest signal) | 245 |
| Last-30-days bug-class | 4 |
